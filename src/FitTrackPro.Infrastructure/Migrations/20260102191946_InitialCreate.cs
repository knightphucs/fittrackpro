        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryMuscle = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    SecondaryMuscles = table.Column<string>(type: "jsonb", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Arms = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true),
                    Legs = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeightGoal = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TDEE = table.Column<int>(type: "integer", nullable: false),
                    TargetProtein = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    TargetCarbs = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    TargetFat = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exercises_PrimaryMuscle",
                table: "Exercises",
